...
* [`src/sosgilbues/org/br/`](src/sosgilbues/org/br/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/sosgilbues/org/br/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `sosgilbues.org.br` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/sosgilbues/org/br/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns sosgilbues.org.br.example
  (:require [sosgilbues.org.br.config :as config])
